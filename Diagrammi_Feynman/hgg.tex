...
\unitlength = 1mm
\begin{fmffile}{hgg_diag} %Creating a diagram called "my_process_diag"
\begin{fmfchar*}(40,25)%(x.y) sono la grandezza del diagramma
%Particelle stato iniziale(i) e finale (o)
\fmfleft{i1} 
\fmfright{o1,o2} \fmflabel{$\gamma$}{o1} \fmflabel{$\gamma$}{o2}

\fmf{dashes,label=$h$}{i1,v1} 
\fmf{boson,left,tension=0.2,tag=1,label=$W$,label.side=left}{v1,v2} 
\fmf{boson,left,tension=0.2,tag=2,label=$W$,label.side=left}{v2,v1}
\fmf{boson}{o1,v2}
\fmf{boson}{v2,o2}
\fmfposition
